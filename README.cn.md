...
[![x-cmd/install — kubecm Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kubecm.svg?lang=zh)](https://x-cmd.com/install/kubecm)
...
- **Star**: 1,145 · **Fork**: 110 · **开放 issue**: 119 · **贡献者**: 30

## 累计统计

- **发布数**: 89 · **已合并 PR**: 387 · **开放 PR**: 9 · **已关闭 issue**: 100 · **开放 issue**: 19 · **提交数**: 614
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kubecm.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:45:51Z._
